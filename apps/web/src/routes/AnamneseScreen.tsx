 ...
 * consistentes em vez de grafias variadas do mesmo nome). Lista ampliada
 * (Flay, incremento pós-lançamento do dropdown) das raças mais vistas em
 * clínicas/pet shops no Brasil, em ordem alfabética — com uma lista maior
 * a ordem por popularidade deixa de ajudar a achar o item, alfabética
 * escala melhor. SRD e Outra continuam fixas no fim (Outra abre um campo
 * de texto livre pra não perder nenhum caso).
 */
const BREED_OPTIONS = [
  'Akita',
  'Australian Shepherd',
